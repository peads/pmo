...
#define CRDP_ANSWER             "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx????????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
#define JUMPS_ANSWER            "xxxx????????xxxx????????xxxx????????xxxx????????xxxx????????"
#define REX_JUMPS_ANSWER        "xxxxxx????????xxxxxx????????xxxxxx????????xxxxxx????????xxxxxx????????xxxxxx????????"
#define OTHER_JUMPS_ANSWER      "xx??xx????????xxxxxxxxxxxxxx????????xxxx"
