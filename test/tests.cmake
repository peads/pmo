...
#    )
#    cmake_path(SET CLANG_RT_PROFILE_LIB NORMALIZE "${CLANG_RT_PROFILE_LIB}")
#    set(LIBS ${LIBS} "${CLANG_RT_PROFILE_LIB}")
#    message(STATUS "${LIBS}")
##    target_link_libraries(${TARGET} PRIVATE ${CLANG_RT_PROFILE_LIB})
#    target_compile_options(${TARGET} PRIVATE /clang:-fcoverage-mapping /clang:-fprofile-instr-generate)
#    target_compile_options(${TARGET} PRIVATE /clang:-fcoverage-mapping /clang:-fprofile-instr-generate)
#    target_compile_definitions(${TARGET} PRIVATE LLVM_ENABLE_RUNTIMES=${MY_LLVM_RTS})
#    target_compile_definitions(${TARGET} PRIVATE LLVM_ENABLE_PROJECTS=${MY_LLVM_PROJS})
##    target_link_libraries(Catch2 PRIVATE ${CLANG_RT_PROFILE_LIB})
##    target_compile_definitions(Catch2 PRIVATE CMAKE_CXX_FLAGS=${MY_CXX_FLAGS})
##    target_compile_definitions(Catch2 PRIVATE CMAKE_C_FLAGS=${MY_C_FLAGS})
#    target_compile_definitions(Catch2 PRIVATE LLVM_ENABLE_RUNTIMES=${MY_LLVM_RTS})
#    target_compile_definitions(Catch2 PRIVATE LLVM_ENABLE_PROJECTS=${MY_LLVM_PROJS})
#endif()
